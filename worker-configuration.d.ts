/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2c032c6ef6519830e6e50f721178b72)
...
declare namespace Cloudflare {
	...
	interface Env {
		OG_BUCKET: R2Bucket;
		BROWSER: Fetcher;
		ALLOWED_HOSTS: ["confettisaas.com","www.confettisaas.com"];
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_HOSTS" | "SCREENSHOT_TIMEOUT_MS">> {}
}
